...
const prisma_repository_1 = require("../common/repository/prisma.repository");
let HotelRepository = class HotelRepository extends prisma_repository_1.PrismaRepository {
    constructor(prisma) {
        super(prisma.room);
    }
};
